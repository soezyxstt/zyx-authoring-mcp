...
|---|---|---|
| `SOURCE_PREPARATION` | Dokumen asli dan urutannya tersedia | Source Pack selesai dibuat |
| `SOURCE_VALIDATION` | ZIP dan seluruh binary asli tersedia | `source.ingest` mengembalikan `valid: true` |
| `SCOPE_CONFIRMATION_REQUIRED` | Source Pack valid dan kandidat course/chapter tersedia | Operator mengonfirmasi pilihan opaque yang ditampilkan |
...
- course/chapter belum dikonfirmasi;
